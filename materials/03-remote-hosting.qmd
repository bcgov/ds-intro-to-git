...
For most projects, I strongly recommend starting with a remote repository **first** (with a README, .gitignore and license automatically included), and then `cloning` this remote repository into a local location. We will go over cloning a repository in a [Section 4: Pulling changes from GitHub(pul)]! 
:::

...
::: {.column width="40%"}
![](/figures/housekeeping.png){fig-pos="t" width="75%"}
...
::: {.incremental} 
-   Section 1: What is version control for code (and why do we want to use it?)
-   Section 2: Working locally with Git: Setting up our first Git repository ![](/figures/git-logo.png){fig-pos="H" width="10%"}
-   Section 3: Remote code-hosting and GitHub: Sharing code on GitHub ![](/figures/github-logo.png){fig-pos="H" width="10%"}
-   Section 4: Open-source code with the BCGov GitHub Organization
...
![](/figures/sequential.png){fig-pos="H"}
...
## A Collaborative Workflow {background-image="/figures/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## A Typical Workflow {background-image="/figures/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## What about our data? (Ignoring things) {background-image="/figures/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## BCGov GitHub Organization  {background-image="/figures/section-4-bcgov/bcgov-logo.png" background-size="10%" background-position="85% 6%" transition="fade-in slide-out" style="padding: 0px 0px 0px 0px;"}

![](/figures/section-4-bcgov/bcgov-org2.png)

::: {.absolute top=625 left=265}
::: {.fragment .fade-up fragment-index="2"}
::: {data-id="box2" auto-animate-delay="0.2" style="background:  #e83e8c ; width: 100px; height: 5px;"}
:::
:::
:::
...
## BC Developer Guide {background-image="/figures/section-4-bcgov/bcgov-logo.png" background-size="10%" background-position="85% 6%" transition="fade-in fade-out"}
...
::: {.absolute top=310 left=280}
::: {.fragment .fade-up fragment-index="2"}
::: {data-id="box2" auto-animate-delay="0.2" style="background:  #e83e8c ; width: 140px; height: 5px;"}
:::
:::
:::
...
## BCGov GitHub Policy Framework {background-image="/figures/section-4-bcgov/bcgov-logo.png" background-size="10%" background-position="85% 6%" transition="fade-in slide-out"}
...
## Repo Content {background-image="/figures/section-4-bcgov/bcgov-logo.png" background-size="10%" background-position="85% 6%" transition="fade-in slide-out"}

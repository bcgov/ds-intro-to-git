...
- Section 2: Working locally with Git
  - Setting up our first Git repository ![](/figures/section-2-git/git-logo.png){fig-pos="H" width="10%"}
- Section 3: Remote code-hosting and GitHub: 
  - Sharing code on GitHub ![](/figures/section-3-github/github-mark.png){fig-pos="H" width="10%"}
- Section 4: BCGov GitHub Organization
  - Coding in the open ![](/figures/section-4-bcgov/bcgov-logo.png){fig-pos="H" width="8%"}
:::
...
::::: columns
::: {.column width="50%"}
![](/figures/section-2-git/git-logo.png){fig-pos="t" width="50%" fig-align="center"}
:::

::: {.column width="50%"}
![](/figures/section-3-github/github-mark.png){fig-pos="t" width="25%" fig-align="center"}
:::
:::::

![](/figures/section-4-bcgov/bc-public-service.png){fig-pos="t" width="80%" fig-align="center"}
...
## Changes saved sequentially {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}

![](/figures/section-1-vc/sequential.png){fig-pos="H"}
...
## Collaborating Branching {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}

:::: columns

::: {.column width="50%"}
![](/figures/section-1-vc/branching.png){fig-pos="t" fig-align="center"}
:::
...
## Collaborating: Merging {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}
...
::: {.column width="50%"}
![](/figures/section-1-vc/collaborating.png){fig-pos="t" fig-align="center"}
:::
...
## Repository {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}
...
## Jargon {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}
...
##  {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}
...
![](/figures/section-1-vc/local-repository.png){fig-pos="t" fig-align="center"}
...
## Remote Repository {background-image="/figures/section-3-github/github-mark.png" background-size="8%" background-position="85% 6%"}
...
##  {background-image="/figures/section-3-github/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## A Collaborative Workflow {background-image="/figures/section-3-github/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## A Typical Workflow {background-image="/figures/section-3-github/github-mark.png" background-size="8%" background-position="85% 6%"}
...
## Ignoring things {background-image="/figures/section-3-github/github-mark.png" background-size="8%" background-position="85% 6%"}
...
![](/figures/section-3-github/data.png){fig-pos="t" fig-align="center" width="75%"}
...
## Repo Content {background-image="/figures/section-4-bcgov/bcgov-logo.png" background-size="8%" background-position="85% 6%" transition="fade-in slide-out"}

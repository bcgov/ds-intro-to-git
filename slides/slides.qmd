...
## What is Version Control? (Not This) {background-image="/figures/section-1-vc/version-control.png" background-size="6%" background-position="85% 6%"}
...
## Repository {background-image="/figures/section-1-vc/version-control.png" background-size="6%" background-position="85% 6%"}
...
## Jargon {background-image="/figures/section-1-vc/version-control.png" background-size="6%" background-position="85% 6%"}
...
## Git {background-image="/figures/section-2-git/git-logo.png" background-size="10%" background-position="85% 6%"}

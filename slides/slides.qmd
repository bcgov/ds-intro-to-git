...
- Section 2: Working locally with Git
  ...
  - ![](/figures/section-2-git/git-logo.png){fig-pos="H" width="10%"}
- Section 3: Remote code-hosting and GitHub: 
  - Sharing code on GitHub 
  - ![](/figures/section-3-github/github-mark.png){fig-pos="H" width="10%"}
- Section 4: BCGov GitHub Organization
  - Coding in the open 
  - ![](/figures/section-4-bcgov/bcgov-logo.png){fig-pos="H" width="10%"}
:::

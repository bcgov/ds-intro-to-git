...
## Bash Jargon Review {background-image="/figures/git-logo.png" background-size="10%" background-position="85% 6%"}
...
## Git Jargon Review {background-image="/figures/git-logo.png" background-size="10%" background-position="85% 6%"}
...
## Local Repository {background-image="/figures/git-logo.png" background-size="10%" background-position="85% 6%"}
...
Bonnie to add image for remote repo
...
:::::::: columns
::: {.column width="50%"}
![](/figures/github-mark.png){fig-pos="t" fig-align="center"}
:::
